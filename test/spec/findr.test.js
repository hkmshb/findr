...
describe('Controllers', function() {
    ...
    describe('HomeCtrl', function() {
        ...
        beforeEach(inject(function($controller, $rootScope, findrService) {
            service = findrService;
            $scope = $rootScope.$new();
